...
//            help[i++] = inputArray[startLeft] < inputArray[startRight] ? inputArray[startLeft++] :
//                    inputArray[startRight++];
//        }
//
//        while (startLeft <= middle) {
//            help[i++] = inputArray[startLeft++];
//        }
//
//        while (startRight <= right) {
//            help[i++] = inputArray[startRight++];
//        }
//
//        for (int j = 0; j < help.length; j++) {
//            inputArray[left + j] = help[j];
//        }
//    }
//
//    public static void main(String[] args) {
//        int[] inputArray = new int[]{1, 3, 4, 5, 3, 2, 5, 3, 53, 345};
